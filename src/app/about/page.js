...
const about = () => {
  ...
  return     <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            ...
            cottages. It&#39;s about the experience of reconnecting with nature and
            enjoying simple pleasures with family.
          </p>
          <p>
            Our 8 luxury cottages provide a cozy base, but the real freedom and
      ...
      <div className="col-span-2 relative aspect-square">
        <Image src="/about-2.jpg"  className="object-cover" fill alt="Family that manages The Maclo Cottages" />
      </div>

      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium">
          Managed by our family since 1992
        </h1>

        <div className="space-y-8">
          <p>
            Since 1992, The Maclo Cottages has been a cherished family-run
          ...
          <p>
            Over the years, we&#39;ve maintained the essence of The Maclo Cottages,
